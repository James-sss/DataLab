...
namespace DataLab.Migrations
{
    ...
    [Migration("20211216152903_addedEnumAccountType")]
    partial class addedEnumAccountType
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FarmApplication.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("DataLab.Models.AuthorizedUsers", b =>
                {
                    ...
                    b.HasOne("FarmApplication.Models.ApplicationUser", "ApplicationUser")
                        .WithMany("AuthorizedUsers")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FarmApplication.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
