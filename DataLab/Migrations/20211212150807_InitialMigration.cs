        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullName = table.Column<string>(type: "nvarchar(100)", nullable: true, computedColumnSql: "[FirstName] + ' ' + [LastName]"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataSource = table.Column<string>(type: "nvarchar(20)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthorizedUsers", x => x.CustomerId);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_AuthorizedUsers_Customers_CustomerId",
